...
import snp.gob.bo.gimodel.solicitudes.mapper.LemasComercialesMapper;
 ...
 */
@Service("formularioPI102Service")
public class FormularioPI102ServiceImpl implements FormularioPI102Service {
    ...
    public FormularioPI102 obtenerDatosFormularioPI102(Long idFormulario) throws Exception {
        try {
            ...
            formularioPI102.setMensaje(null);
            ...
            formularioPI102.setFormularios(formularios);
            ...
            formularioPI102.setSolicitantes(listaSolicitantes);
            ...
            formularioPI102.setApoderados(listaApoderados);
            ...
            formularioPI102.setDirecciones(listaDirecciones);
...
//                //Obtener el listado de las prioridades
            ...
            formularioPI102.setPrioridades(listaPrioridades);
            ...
            formularioPI102.setSignoMarca(signoMarcas);

            LemasComerciales lemasComerciales = jdbcTemplate.queryForObject("select * from formulario.lemascomerciales where signomarca_id = ?", new LemasComercialesMapper(), signoMarcas.getId());
            formularioPI102.setLemasComerciales(lemasComerciales);
            ...
            for (Map<String, Object> map : smSignosClasesNiza) {
                ...
                if (map.get("claseniza_id") != null) {
                    ...
                    smSignoClaseNizas.setClaseNizaId(46L);
                }
            ...
            formularioPI102.setSmSignoClaseNizases(listaSmSignoClaseNizas);
            ...
            formularioPI102.setSmTipoSignos(listaSmTipoSignos);

            //Obtener el listado de Logotipos
            List<Logotipos> listaLogotipos = new ArrayList<>();

            List<Map<String, Object>> logotipos = jdbcTemplate.queryForList("select * from formulario.logotipos where signomarca_id = ? and estado='AC'", signoMarcas.getId());
...
//                    logotipo.setImagen(Bytes.parseByte(map.get("imagen").toString()));
            ...
            formularioPI102.setLogotipos(listaLogotipos);
