 ...
 * @author susana
 */
public class ModTitularLicenciatarioNuevo implements Serializable {

    Long idtitularlicenciatario;
    Long idmodificacion;
    Long idlogtrans;
    String tipo_titular;
    String tipo_persona;
    ...
    public Long getIdtitularlicenciatario() {
        return idtitularlicenciatario;
    }

    public void setIdtitularlicenciatario(Long idtitularlicenciatario) {
        this.idtitularlicenciatario = idtitularlicenciatario;
    }
    ...
    public String getPais_constitucion() {
        return pais_constitucion;
    }

    public void setPais_constitucion(String pais_constitucion) {
        this.pais_constitucion = pais_constitucion;
    }
    ...
    public String toString() {
        ...
        return "|" + "idtitularlicenciatario=" + idtitularlicenciatario
