 ...
 * @author eddy
 */
@ManagedBean(name = "observacionTramiteSignoBean")
@ViewScoped
public class ObservacionTramiteSignoBean extends AbstractManagedBean implements Serializable {
...
//            }
            ...
            Logger.getLogger(ObservacionTramiteSignoBean.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public void eliminarItemObservacion(ObservacionTramite observacionTramite) {
        try {
            ...
            observacionTramite.setEstado("AN");
