 ...
 *
 */
@ManagedBean(name = "busquedaSignosBean")
@ViewScoped
public class BusquedaSignosBean extends AbstractManagedBean implements Serializable {
    ...
    public void accionRealizarBusquedaMarca() {
        ...
        try {
            ...
            Logger.getLogger(BusquedaSignosBean.class.getName()).log(Level.SEVERE, null, ex);
        }
