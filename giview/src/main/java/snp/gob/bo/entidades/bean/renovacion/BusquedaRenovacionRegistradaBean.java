 ...
 * @author ChanoRojas
 */
@ManagedBean(name = "busquedaRenovacionRegistradaBean")
@ViewScoped
public class BusquedaRenovacionRegistradaBean extends AbstractManagedBean implements Serializable {
...
//<editor-fold defaultstate="collapsed" desc="-----------------VARIABLES DE ENTORNO--------------">
    ...
    private RenRenovacion renRenovacionBusqueda;
    ...
    private String numero_renovacion_busqueda;
...
//</editor-fold>
    public BusquedaRenovacionRegistradaBean() {
        renRenovacionBusqueda = new RenRenovacion();
    }
...
//        renDireccionDeNotificacion = new RenDireccionDeNotificacion();
    ...
    public void inicializaDatosRenovacion(RenSolicitudRenovacion renSolicitdRenovacion) throws Exception {
        ...
        if (renRenovacion.getIdrenovacion() != null) {
            ...
            inicializaValores();
            if (renSolicitdRenovacion.getIdclase_niza_reclasificacion() > 1) {
            ...
            renRenovacion.setFecha_concesion(renSolicitdRenovacion.getFecha_registro_registrado());
...
//            renResolucion.setNumero_resolucion(0);
    ...
    public String navegaRenovaciones() {
...
//    public void actualizaNumeroRenovacion(RenRenovacion renRenovacion){
//        System.out.println("ingreso  metodo de numero asignacion"+numeroRegistrobuscador);
//        numeroAsignadoConfirmacion=numeroRegistrobuscador+"-"+renRenovacion.getSerie_renovacion();
//        System.out.println("numeroconfirmacion"+ numeroAsignadoConfirmacion);
//    
//    }
    public void cierraDialogo() {
        System.out.println("ingreso al metodo de cierre de popup:::::::::::::");
...
//        inicializaTodo();
    ...
    public String concatenaApoderado(List<RenSolicitanteApoderado> listaApoderado) {
        ...
        System.out.println("cadena de apoderados" + cadenaApoderado);
    ...
    public void accionBuscarSimple() throws Exception {
        ...
        if (!numero_renovacion_busqueda.equals("")) {
            renRenovacionBusqueda = renRenovacionService.obtieneRenRenovacionPorNumeroYSerieRenovacion(Integer.parseInt(numero_renovacion_busqueda), serieRenovacionNuevo);
            renSolicitudRenovacionRepo = renSolicitudRenovacionService.obtenerRenSolicitudXIdRenSolicitud(renRenovacionBusqueda.getIdsolicitudrenovacion());
            System.out.println("renovaacion" + renRenovacionBusqueda.getIdrenovacion());
            renSolicitudRenovacion = renSolicitudRenovacionService.obtenerRenSolicitudXIdRenSolicitud(renRenovacionBusqueda.getIdsolicitudrenovacion());
            renResolucion = renResolucionService.obtieneRenResolucionPorIdRenovacion(renRenovacionBusqueda.getIdrenovacion());
            cadenaTipoSigno = concatenaTipoSigno(renTipoSignoService.buscaRenTipoSignoPorIdSolicitud(renSolicitudRenovacion.getIdsolicitudrenovacion()));
            cadenaTipoGenero = renSolicitudRenovacion.getTipo_genero();
//            listaTitularRegistrado = (List<RenTitularRegistrado>) renTitularRegistradoService.buscaRenTitularRegistradoPorIdSolicitud(renSolicitudRenovacion.getIdsolicitudrenovacion());
//            renRenovacion = renRenovacionService.obtieneRenovacionPorIdSolicitud(renSolicitdRenovacion.getIdsolicitudrenovacion());
//            cad   enaTitular = concatenaTitular(listaTitularRegistrado);
        } else {
            FacesContext.getCurrentInstance().addMessage(null,
                    new FacesMessage(FacesMessage.SEVERITY_INFO, "Debe introducir un numero de registro", ""));
     ...
     */
    public void imprimirTitulo(String codigo) throws JRException, IOException, Exception {
     ...
     * @throws java.io.IOException
     */
    public void imprimirResolucion(String codigo) throws JRException, IOException, Exception {
        ...
        if (renSolicitudRenovacionRepo.getIdsolicitudrenovacion() != null) {
            ...
            if (renRenovacionRepo.getIdrenovacion() != null) {
                ...
                if (renResolucionRepo.getIdrenovacion() != null) {
                    ...
                    if (renSolicitudRenovacionRepo.getFecha_ingreso() != null) {
                        fechaSolicitudAux = formateador1.format(renSolicitudRenovacionRepo.getFecha_ingreso());
                    }

                    String fechaConcesionAux = "";
                    if (renRenovacionRepo.getFecha_concesion() != null) {
                        fechaConcesionAux = formateador1.format(renRenovacionRepo.getFecha_concesion());
                    }
...
//<editor-fold defaultstate="collapsed" desc="-----------------------------GET'S  AND SET'S----------------------">
    ...
    public String getNumero_renovacion_busqueda() {
        return numero_renovacion_busqueda;
    }

    public void setNumero_renovacion_busqueda(String numero_renovacion_busqueda) {
        this.numero_renovacion_busqueda = numero_renovacion_busqueda;
    }

    public RenRenovacion getRenRenovacionBusqueda() {
        return renRenovacionBusqueda;
    }

    public void setRenRenovacionBusqueda(RenRenovacion renRenovacionBusqueda) {
        this.renRenovacionBusqueda = renRenovacionBusqueda;
    }
